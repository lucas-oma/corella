...
const POST_CALL_FIELDS: FieldVar[] = [
  ...
  { key: "sentiment", kind: "string", hint: "Hostile / Tense / Frustrated / Skeptical / Neutral / Engaged / Positive / Enthusiastic" },
  ...
  { key: "talk_ratio", kind: "json", hint: 'meeting_tab only: {"me": <pct>, "them": <pct>}' },
  { key: "speaker_share", kind: "json", hint: '[{"label": "Speaker 1", "pct": 40}, …] (all capture modes)' },
